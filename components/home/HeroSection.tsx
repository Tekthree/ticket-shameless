      ...
      <div
        ...
        <video
          ...
          style={{
            ...
            transition:
              'opacity 1.4s cubic-bezier(0.22,1,0.36,1), transform 1.6s cubic-bezier(0.22,1,0.36,1)',
          }}>
        ...
        <div
          ...
          <h1
            ...
            <span
              style={{
                ...
                transition:
                  'opacity 0.85s cubic-bezier(0.22,1,0.36,1) 0.18s, transform 0.85s cubic-bezier(0.22,1,0.36,1) 0.18s',
              }}>
              Simply
            </span>
            <span
              style={{
                display: 'block',
                color: 'transparent',
                WebkitTextStroke: `1.5px ${C.darkText}`,
                opacity: loaded ? 1 : 0,
                transform: loaded ? 'translateY(0)' : 'translateY(40px)',
                transition:
                  'opacity 0.85s cubic-bezier(0.22,1,0.36,1) 0.3s, transform 0.85s cubic-bezier(0.22,1,0.36,1) 0.3s',
              }}>
              Shameless.
            </span>
          </h1>
          ...
          <div
            style={{
              ...
              transform: loaded ? 'translateY(0)' : 'translateY(24px)',
              transition:
                'opacity 0.85s cubic-bezier(0.22,1,0.36,1) 0.6s, transform 0.85s cubic-bezier(0.22,1,0.36,1) 0.6s',
            }}>
            <Link
              href='/events'
              ...
              onMouseEnter={(e) => {
                ...
                e.currentTarget.style.boxShadow =
                  '0 8px 24px rgba(201,50,26,0.35)';
              }}
              onMouseLeave={(e) => {
