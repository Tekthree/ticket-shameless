    ...
    <div style={{ minHeight: '100vh', background: C.dark }}>
      ...
      <div className="ep-hero">
        {safeImageUrl(event.banner_url ?? event.image_url) ? (
          <Image src={safeImageUrl(event.banner_url ?? event.image_url)!} alt={event.venue ? `${event.title} at ${event.venue}, Seattle WA` : event.title} fill sizes="100vw" style={{ objectFit: 'cover', objectPosition: 'center 30%' }} priority />
        ) : (
